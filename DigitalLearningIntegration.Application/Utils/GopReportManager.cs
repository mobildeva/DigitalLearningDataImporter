...
namespace DigitalLearningIntegration.Application.Utils
{
    public static class GopReportManager
    {
        ...
        public static void GenerateLogMonitorFile(string filePath, ImportLogInfo info)
        {
            try
            {
                ...
                writer.WriteLine("- Fecha: " + info.DateOfFile.ToString("HH:mm yyyyMMdd"));
                writer.WriteLine("- Estado: " + info.State);
                writer.WriteLine("- Altas o Registros creados: " + info.CountOfRowsInserted);
                writer.WriteLine("- Actualización de registros activos: " + info.CountOfRowsUpdates);
                writer.WriteLine("- Bajas o registros desactivados: " + info.CountOfDeactivates);
                writer.WriteLine("- Registros inválidos: " + info.Invalids);
                writer.Close();
                ostrm.Close();
            }
            catch (Exception ex)
